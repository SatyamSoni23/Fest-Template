	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="container-right" style = "background-image: url('../images/pronight.jpg'); background-size: cover;">
				</div>
				<form class="login100-form-register validate-form" method="post" action="pdf.php">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type = "submit" value="Pronight" name="ticket" onclick="return testcheck()">
							Book Ticket
						</button>
					</div>
					<script>
